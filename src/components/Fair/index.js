...
import { DescribSec, DescribPar, ChartDiv, ToolKit } from "./style"
  ...
  render() {
    ...
    return (
      <Container>
        ...
        {this.props.isLogged ? <FairData addData={this.addData} /> : null}
        <ChartDiv>
          <ToolKit>
            <Button
              style={{ backgroundColor: "#D6D7AD", marginTop: "10px" }}
              fullWidth
            >
